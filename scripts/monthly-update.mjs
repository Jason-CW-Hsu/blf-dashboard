...
function html(snapshot) {
  ...
  return page.replace(/c=\[[^\]]+\]/, "c=['#9dc3e6','#5b9bd5','#2f75b5','#1f4e79','#f4b183','#f7c9a9','#ed7d31','#c55a11']").replace('</main>', `${drilldownPanel}</main>`).replace('</script></body></html>', `<style>.manager-row{cursor:pointer}.manager-row:hover{background:#eaf3fb}.drilldown{margin-top:20px}.drilldown-table-wrap{overflow-x:auto}.drilldown table{min-width:1050px}</style>${drilldownScript}</body></html>`);
}
