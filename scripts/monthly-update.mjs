...
function html(snapshot) {
  ...
  const chartItems=['固定收益','權益證券','另類投資','其他'];
  const chartGroups=[['自行運用-國外-固定收益','委託經營-國外-固定收益'],['自行運用-國外-權益證券','委託經營-國內-權益證券','委託經營-國外-權益證券'],['自行運用-國外-另類投資','委託經營-國外-另類投資'],['轉存金融機構','政策性貸款','短期票券','公債、公司債、金融債券及特別股','公債、金融債券、公司債及證券化商品','房屋及土地','政府或公營事業貸款','被保險人貸款','股票及受益憑證投資（含期貨）']];
